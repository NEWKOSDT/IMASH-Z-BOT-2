...
module.exports = {
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By Z BOT' : process.env.ALL_CAPTION,
    MENTION: process.env.TAG_REPLY === undefined ? '94771323434@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BOT: process.env.BOT_NAME === undefined ? '----Z BOT----' : process.env.BOT_NAME,
